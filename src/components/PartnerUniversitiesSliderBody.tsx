...
const PartnerUniversitiesSliderBody = (): JSX.Element => {
        ...
        <div className="keen-slider__slide" key={`${partner.name}-${index}`}>
          <div className="partner-logo-tile">
            <img
              ...
              width={320}
              height={160}
              sizes="(max-width: 576px) 45vw, (max-width: 768px) 35vw, (max-width: 992px) 25vw, 20vw"
            />
          </div>
        </div>
      ))}
...
export default PartnerUniversitiesSliderBody;
