...
const footerColumns = [
  ...
  },
  {
    ...
    items: [
      { label: "Study in UK", href: "/study-destinations/uk" },
      { label: "Study in USA", href: "/study-destinations/usa" },
      { label: "Study in Canada", href: "/study-destinations/canada" },
      { label: "Study in Australia", href: "/study-destinations/australia" },
      { label: "Study in Germany", href: "/study-destinations/germany" },
      { label: "Study in France", href: "/study-destinations/france" },
      { label: "Study in Ireland", href: "/study-destinations/ireland" },
      { label: "Study in Spain", href: "/study-destinations/spain" },
      { label: "Study in UAE", href: "/study-destinations/uae" },
      { label: "Study in Malta", href: "/study-destinations/malta" },
    ],
  },
  {
    title: "Programmes",
