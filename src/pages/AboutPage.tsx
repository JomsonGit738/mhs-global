...
const aboutSections: AboutSection[] = [
  {
    title: 'Who We Are',
    body:
      'MHS Global Associates is dedicated to empowering students with the right guidance and support to transform their dreams of global education into reality.',
  },
  {
    title: 'Our Vision',
    body:
      'Founded in 2020, MHS Global Associates was built on a mission to empower students to reach their highest academic and career potential. With a clear vision of creating global opportunities, the consultancy has quickly established itself as a trusted bridge between ambitious learners and world-class educational institutions.',
  },
  {
    title: 'Student-Centered Approach',
    body:
      'At MHS Global Associates, every student is at the heart of what we do. Our team provides personalized guidance, from selecting the right course and university to ensuring smooth application and visa processes. By tailoring strategies to individual needs, we make each journey stress-free, transparent, and inspiring.',
  },
  {
    ...
    <>
      <section className="about-hero position-relative text-white">
        ...
        <div className="container position-relative py-5 py-lg-6">
          ...
          <h1 className="display-5 fw-bold mb-2">We are MHS Global Associates.</h1>
          <p className="lead text-white-75 mb-0 col-lg-6">
            Since our inception, we have helped aspiring students unlock pathways to world-class education with end-to-end guidance and personalised support.
          </p>
        </div>
      </section>
            ...
            <div className="col-lg-8">
              <div className="d-flex flex-column gap-4">
                {aboutSections.map((section) => (
                  <article key={section.title} className="about-section">
                    <h2 className="h4 fw-bold text-dark mb-2">{section.title}</h2>
              ...
              <div className="card border-0 shadow-sm about-contact-card mt-5">
                <div className="card-body p-4 p-lg-5">
                  <h3 className="h4 fw-bold text-dark mb-3 text-center">Get In Touch</h3>
              ...
              <aside className="d-flex flex-column gap-4">
                <div className="card border-0 shadow-sm">
                  <div className="card-body">
                    <h3 className="h6 fw-semibold text-dark mb-3">Our Services</h3>
                ...
                <div className="card border-0 shadow-sm">
                  <div className="card-body">
                    <h3 className="h6 fw-semibold text-dark mb-3">Course Links</h3>
                    <ul className="list-unstyled d-flex flex-column gap-2 mb-0">
